        ...
        <form action="delete_flight_details_form_handler.php" method="post">
            ...
            <div>
                ...
                if (isset($_GET['msg']) && $_GET['msg'] == 'success') {
                    echo "<strong style='color:green;'>The Flight Schedule has been successfully deleted.</strong><br><br>";
                } else if (isset($_GET['msg']) && $_GET['msg'] == 'failed') {
                    echo "<strong style='color:red;'>*Invalid Flight No./Departure Date, please enter again.</strong><br><br>";
                }
                ?>
                <table cellpadding="5">
                    <tr>
